...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('register', '0008_alter_user_field_of_work_alter_user_key_skills_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ratings', models.ManyToManyField(blank=True, related_name='rated_users', to='register.rating')),
        ...
        migrations.AlterField(
            model_name='rating',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ratings_given', to='register.customuser'),
        ),
